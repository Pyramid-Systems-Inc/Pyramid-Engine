...
- [x] Readable owned Arabic reference outlines, explicit joining-edge geometry, 48-pixel supersampled reference atlases, deterministic regeneration, and linear UI font sampling.

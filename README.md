...
| Tests | 56 CTest targets, including standalone foundation, math, input, image, model, font, text, UI, and runtime-path coverage plus focused engine/reference-game tests |

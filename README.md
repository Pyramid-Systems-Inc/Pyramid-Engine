...
| Tests | 27 CTest targets: 5 image/utility tests plus API linkage and focused graphics/platform coverage |
...
- OpenGL device, a game-owned `ResourceRegistry`, generation-checked typed resource handles, engine-owned mesh and material resources, stable resource identifiers, content-deduplicating mesh, shader-program, texture, and material caches, buffers, vertex arrays, shaders, textures, resize-safe framebuffers, and state caching.

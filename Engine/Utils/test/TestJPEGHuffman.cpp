...
bool TestJPEGHuffmanDecoding()
{
    ...
    // Test data: 0b01 (should decode to symbols 0, 1)
    uint8_t testData[] = {0x40}; // 0b01000000 (reading from MSB)
    BitReader bitReader(testData, 1);
    
    // Decode first symbol (should be 0)
    ...
    // Decode second symbol (should be 1)

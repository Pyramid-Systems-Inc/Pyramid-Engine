...
namespace Vectors {
    // Vec2 constants
    constexpr Vec2 Zero2D = Vec2(0.0f, 0.0f);
    constexpr Vec2 One2D = Vec2(1.0f, 1.0f);
    constexpr Vec2 Right2D = Vec2(1.0f, 0.0f);
    constexpr Vec2 Up2D = Vec2(0.0f, 1.0f);
    
    // Vec3 constants
    constexpr Vec3 Zero3D = Vec3(0.0f, 0.0f, 0.0f);
    constexpr Vec3 One3D = Vec3(1.0f, 1.0f, 1.0f);
    constexpr Vec3 Right3D = Vec3(1.0f, 0.0f, 0.0f);
    constexpr Vec3 Up3D = Vec3(0.0f, 1.0f, 0.0f);
    constexpr Vec3 Forward3D = Vec3(0.0f, 0.0f, 1.0f);
}

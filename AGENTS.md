...
- Input, audio, physics, editor, scripting, DirectX, Vulkan, Linux, and macOS are not supported. The first product target is a Windows RTS vertical slice; Linux follows it, a full editor is planned, and Baa is the long-term scripting and rewrite target.

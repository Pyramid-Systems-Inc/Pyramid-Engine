...
- Native MinGW builds must keep `PYRAMID_BUNDLE_MINGW_RUNTIME` enabled by default so compiler runtime DLLs are copied beside build/install executables; do not require users to edit `PATH` merely to launch Pyramid examples.
